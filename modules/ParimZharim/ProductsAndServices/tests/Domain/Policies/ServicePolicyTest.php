...
use Modules\ParimZharim\ProductsAndServices\Domain\Policies\ServicePolicy;
...
class ServicePolicyTest extends TestCase
{
    ...
    public function it_allows_view_if_user_has_permission()
    {
        ...
        $this->assertTrue($this->policy->view($this->user, $this->service));
    }
    ...
    public function it_allows_update_if_user_has_permission()
    {
        ...
        $this->assertTrue($this->policy->update($this->user, $this->service));
    }
    ...
    public function it_allows_replicate_if_user_has_permission()
    {
        ...
        $this->assertTrue($this->policy->replicate($this->user, $this->service));
    }

    /** @test */
    public function it_denies_force_delete()
    {
        $this->assertFalse($this->policy->forceDelete($this->user, $this->service));
    }
    ...
    public function it_allows_delete_if_user_has_permission()
    {
        ...
        $this->assertTrue($this->policy->delete($this->user, $this->service));
    }
    ...
    public function it_allows_restore_if_user_has_permission()
    {
        ...
        $this->assertTrue($this->policy->restore($this->user, $this->service));
    }
    ...
    public function it_returns_null_if_user_does_not_have_permission_for_view()
    {
        ...
        $this->assertNull($this->policy->view($this->user, $this->service));
    }
    ...
    public function it_returns_null_if_user_does_not_have_permission_for_update()
    {
        ...
        $this->assertNull($this->policy->update($this->user, $this->service));
    }
    ...
    public function it_returns_null_if_user_does_not_have_permission_for_replicate()
    {
        ...
        $this->assertNull($this->policy->replicate($this->user, $this->service));
    }
    ...
    public function it_returns_null_if_user_does_not_have_permission_for_delete()
    {
        ...
        $this->assertNull($this->policy->delete($this->user, $this->service));
    }
    ...
    public function it_returns_null_if_user_does_not_have_permission_for_restore()
    {
        ...
        $this->assertNull($this->policy->restore($this->user, $this->service));
    }
}
