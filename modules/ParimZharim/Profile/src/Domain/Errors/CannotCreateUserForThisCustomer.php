...
class CannotCreateUserForThisCustomer extends BaseError implements HttpExceptionInterface{

    private string $clientMessage;
    public function __construct($clientMessage = "Невозможно создать пользователя для этого клиента")
    {
