...
class MoreThanOneScheduleOnDate extends BaseError implements HttpExceptionInterface{

    private string $clientMessage;
    public function __construct($message = "Найдено более одного расписания на дату")
    {
