...
use Modules\ParimZharim\Orders\Application\Actions\SyncWithExternalSystem;
...
class SyncOrderWithExternalSystemAdminAction extends BaseAdminAction
{
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        foreach ($models as $model) {
            try {
                SyncWithExternalSystem::make()->handle($model->id);
    ...
    {
        return 'Пометить внесенным в iiko';
    }
