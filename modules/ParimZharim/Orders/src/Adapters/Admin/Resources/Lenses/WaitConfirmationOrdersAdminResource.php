...
use Modules\ParimZharim\Orders\Adapters\Admin\Filters\WaitAdminOrderStatusFilter;
...
class WaitConfirmationOrdersAdminResource extends Lens {
    ...
    {
        return 'wait-confirmation-orders';
    }
