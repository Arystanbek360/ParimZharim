...
class GetSlotsForServiceObjectOnDate extends BaseAction {

    public function handle(int $orderableServiceObjectID, Carbon $startDate, Carbon $endDate, int $minutesStep = 30): array
    {
        return OrderableObjectSlotsCalculatorService::getSlotsForObjectOnDate($orderableServiceObjectID, $startDate, $endDate, $minutesStep);
    }
}
