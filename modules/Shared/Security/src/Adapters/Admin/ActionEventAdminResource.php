...
namespace Modules\Shared\Security\Adapters\Admin;
...
class ActionEventAdminResource extends BaseAdminResource
{
    /**
    ...
    public function fields(NovaRequest $request): array
    {
        ...
        return [
            ...
            DateTime::make(Nova::__('Action Happened At'), 'created_at')
                ->displayUsing(function ($value) use ($request){
                    $switchedValue = $value->setTimezone(Nova::resolveUserTimezone($request));
                    return $switchedValue ? $switchedValue->isoFormat('dd, D MMMM YYYY HH:mm') : 'Нет данных';
                })
