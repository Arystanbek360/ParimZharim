    ...
    >
        <template #field>
            ...
            >
                ...
                <div class="mt-1 pb-4 md:mt-0 px-6 md:px-8 md:py-5">
            ...
            <div
                class="px-6 py-2 md:px-8 md:mt-0 cursor-pointer md:py-5 border-2 font-bold border-dashed border-gray-200 dark:border-gray-700 hover:border-primary-500 rounded-lg"
                @click="addRow">
